...
На первом этапе тебе необходимо подобрать компанию и вакансию в ней для прохождения стажировки. На выбор вакансии накладываются следующие ограничения и условия:
